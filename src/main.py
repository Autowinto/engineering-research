            ...
            while total_requested < max_commits:
                ...
                for commit in page_commits:
                    ...
                    python_changes = [
                        ...
                        and file.get("patch")
                        # Only include if the commit touches 1 file and not more
                        and len(details.get("files", [])) == 1
                    ]
                    ...
                    if python_changes:
                        ...
                        # Show progress
                        if len(commits) % 5 == 0:
                            print(f"Found {len(commits)} bug-fix commits so far...")
...
def save_commits_data(
    repo_name: str, commits_data: List[Dict[str, Any]], base_dir: str = "commits_data"
):
        ...
        "commits": [
            {
                ...
                "changes": [
                    {"file": change["file"], "patch": change["patch"]}
...
if __name__ == "__main__":
    ...
    exclude_keywords = ["merge", "sync", "typo", "docs", "documentation", "readme"]
    ...
    for idx, repo in enumerate(python_repos):
        ...
        try:
            ...
            if not commits:
                print(f"No matching commits found for {repo_name}, skipping...")
                continue
